# This script will defer the Major OS upgrade by 30 days in macOS. This script will be deployed across all the assignment groups except the Ring 1 and Beta Testers.
